...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Evelyn"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Evelyn "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Evelyn"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Evelyn — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Evelyn",
            "welcome": "Welcome to Evelyn! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Evelyn ",
            "prompt_symbol": "❯",
