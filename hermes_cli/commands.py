...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Evelyn config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Evelyn works on across turns until achieved", "Session",
    ...
    CommandDef("reasoning", "Manage reasoning effort and display", "Configuration",
               ...
               subcommands=("none", *VALID_REASONING_EFFORTS, "show", "hide", "on", "off", "full", "clamp")),
    ...
    CommandDef("busy", "Control what Enter does while Evelyn is working", "Configuration",
    ...
    CommandDef("update", "Update Evelyn (powered by Hermes Agent) to the latest version", "Info"),
    CommandDef("version", "Show Evelyn version", "Info", aliases=("v",)),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Evelyn or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
