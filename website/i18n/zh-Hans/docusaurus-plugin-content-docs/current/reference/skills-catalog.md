...
| [`independent-review-governance`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-independent-review-governance) | 在启动任何跨代码、研究、文档或制品的独立 Reviewer、Codex、Claude、人工或领域审查前使用，包括首次审查、既有 pass 不确定和多执行者共享审查权。 | `autonomous-ai-agents/independent-review-governance` |
