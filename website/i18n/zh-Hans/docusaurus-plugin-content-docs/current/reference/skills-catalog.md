...
| [`requesting-code-review`](/user-guide/skills/bundled/software-development/software-development-requesting-code-review) | 当已完成的软件改动涉及 shared/core、认证安全、并发、验证、不可逆动作或公共契约风险，并需要在落地前进行全新独立审查时使用。 | `software-development/requesting-code-review` |
