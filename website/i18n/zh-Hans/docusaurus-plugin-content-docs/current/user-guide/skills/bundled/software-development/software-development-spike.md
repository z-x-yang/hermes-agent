...
```
delegate_task(tasks=[
    {"description": "构建 pdfjs spike", "prompt": "Build 002a-pdf-parse-pdfjs: ...", "subagent_type": "general-purpose"},
    {"description": "构建 camelot spike", "prompt": "Build 002b-pdf-parse-camelot: ...", "subagent_type": "general-purpose"},
])
```
