...
| Path | `skills/autonomous-ai-agents/independent-review-governance` |
| Version | `1.0.0` |
| Author | Evelyn |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `independent-review`, `governance`, `delegation`, `verification`, `convergence` |
| Related skills | [`code-review-execution`](/docs/user-guide/skills/bundled/software-development/software-development-code-review-execution), `receiving-code-review`, `verification-before-completion` |
