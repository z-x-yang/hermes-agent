---
title: "Evelyn Agent Skill 编写——在仓库中编写 SKILL"
sidebar_label: "Evelyn Agent Skill 编写"
description: "在仓库中编写 SKILL.md"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Evelyn Agent Skill 编写
...
|---|---|
| 来源 | 内置（默认安装） |
| 路径 | `skills/software-development/evelyn-agent-skill-authoring` |
| 版本 | `1.1.0` |
| 作者 | Hermes Agent |
| 许可证 | MIT |
| 平台 | linux, macos, windows |
| 标签 | `skills`, `authoring`, `hermes-agent`, `conventions`, `skill-md` |
| 相关 skill | [`writing-plans`](/user-guide/skills/bundled/software-development/software-development-writing-plans), [`code-review-execution`](/user-guide/skills/bundled/software-development/software-development-code-review-execution) |

## 参考：完整 SKILL.md

:::info
以下是 Evelyn 在触发此 skill 时加载的完整 skill 定义。这是 agent 在 skill 激活时所看到的指令内容。
:::

# 编写 Evelyn Skills（仓库内）
