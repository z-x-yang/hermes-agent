...
CODING_AGENT_GUIDANCE = (
    ...
    "- Write comments only for constraints the code itself can't show — never "
    "to narrate what the next line does, where the change came from, or why "
    "your change is correct; that's addressed at the reviewer and becomes "
    "noise once merged. Match the surrounding file's comment density.\n"
