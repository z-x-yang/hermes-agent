...
def init_agent(
    ...
    # communication, assessment-first, side-effect confirmation,
    # proportionality, observed-content boundary, continuity + precedence).
    # Default True.  One flag for the whole family — they are designed as a set.
    ...
    try:
        ...
        persistent_overload_threshold = max(persistent_overload_threshold, 1)
    except (TypeError, ValueError):
