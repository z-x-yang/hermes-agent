...
def build_turn_context(
    ...
    *,
    ...
    # Tell auxiliary_client what the effective main provider/model are for this
    # turn AFTER primary restoration. Gateway reuses AIAgent instances across
    # messages; if the previous turn fell back, syncing before restore would pin
    # compression/title-generation auxiliary calls to the stale fallback backend.
    try:
