...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Evelyn' : 'Setting up Evelyn'
  const description = isUpdate
    ? 'Evelyn is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Evelyn installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
