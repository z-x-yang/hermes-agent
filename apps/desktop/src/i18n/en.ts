...
export const en: Translations = {
  ...
  boot: {
    ready: 'Evelyn is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Evelyn settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Evelyn…'
    },
    errors: {
      backgroundExited: 'Evelyn background process exited.',
      backgroundExitedDuringStartup: 'Evelyn background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Evelyn backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Evelyn.',
    ...
    native: {
      ...
      inputBody: 'Evelyn is waiting for your response.',
      turnDoneTitle: 'Evelyn finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Evelyn defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Evelyn is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Evelyn asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Evelyn was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Evelyn follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Evelyn is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Evelyn, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Evelyn checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Evelyn configuration...',
    ...
    gateway: {
      ...
      intro:
        'Evelyn starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Evelyn backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Evelyn backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Evelyn backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Evelyn will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Evelyn ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Evelyn runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Evelyn builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Evelyn to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Evelyn to generate pets.',
      backgroundHint: 'You can close this — Evelyn will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Evelyn desktop' },
    ...
    hermesActiveSessions: (version, count) => `Evelyn ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Evelyn environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Evelyn will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Evelyn backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Evelyn. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Evelyn...',
    placeholderReconnecting: 'Reconnecting to Evelyn…',
    ...
    attachUrlDesc: 'Evelyn will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Evelyn to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Evelyn…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Evelyn…',
    ...
    unsupportedMessage: 'This version of Evelyn can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Evelyn from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Evelyn will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Evelyn desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Evelyn updater takes over in its own window and reopens Evelyn automatically when it’s done. Please don’t reopen Evelyn yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Evelyn reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Evelyn reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Evelyn needs a one-time install',
    ...
    settingUpTitle: 'Setting up Evelyn',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Evelyn CLI or desktop instance is running. Stop any running Evelyn instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Evelyn",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Evelyn is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Evelyn…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Evelyn',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Evelyn at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Evelyn connects automatically',
    ...
    authorizeThere: 'Authorize Evelyn there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Evelyn there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Evelyn v${version}`,
      ...
      gatewayTitle: 'Evelyn inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Evelyn will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Evelyn is restarting...',
      askRestart: 'Ask Evelyn to restart the server',
      lookingRestart: taskId => `Evelyn is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Evelyn is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Evelyn finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Evelyn could not restart the server.',
      stillWorking:
        'Evelyn is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Evelyn is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Evelyn gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Evelyn won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Evelyn needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Evelyn needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Evelyn to use Save Image.',
    restartToSaveImages: 'Restart Evelyn to save images',
